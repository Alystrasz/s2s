global function MaltaTriggersInit
...
void function MaltaTriggersInit()
{
	if( GetMapName() != "mp_s2s" )
	{
		return
	}
    AddCallback_GameStateEnter( eGameState.Playing, SetupMaltaTriggers )
...
void function SetupMaltaTriggers()
{
